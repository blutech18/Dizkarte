...
vi.mock("@/lib/repository", () => ({
  getAdminRepository: () => ({ listReviews }),
}));
...
describe("reviews page streaming shell and filters", () => {
  ...
  it("puts the results region behind a Suspense boundary with a skeleton fallback", async () => {
    const shell = (await ReviewsPage({ searchParams: Promise.resolve({}) })) as ReactElement;
